...
<div class="hero-wrap" style="background-image: url('images/bg_neurologie.jpg'); background-attachment:fixed;">
      ...
      <div class="container">
        <div class="row no-gutters slider-text align-items-center justify-content-center" data-scrollax-parent="true">
          <div class="col-md-8 ftco-animate text-center">
            ...
            <h1 class="mb-3 bread"> Département Neurologie</h1>
          </div>
        </div>
      </div>
    </div>
      ...
      <div class="container">
        <div class="row">
          <div class="col-md-8 ftco-animate">
            <p>
              <img src="images/thesis_img/norologie.jpg" alt="" class="img-fluid">
            </p>
            <h5 class="text-danger">SPÉCIALITÉ </5>
            <h2 class="mb-3">Neurologie</h2>
            <p>Le pôle neurologie de la Clinique du Parc accueille les patients pour les consultations et les explorations neurologiques. Il prend en charge les affections du cerveau, de la moelle épinière, des nerfs périphériques, des muscles, l’imagerie neurologique et Doppler et les consultations mémoires.
                        </p>
            </div> 
          <div class="col-md-4 sidebar ftco-animate">
              ...
              <div class="col-md-8 ftco-animate">
                        ...
                        <h2 class="mb-3  ">Les consultations, les explorations fonctionnelles et les hospitalisations</h2>
            <p>Les docteurs du pôle neurologie diagnostiquent et traitent toutes les maladies concernant la neurologie de façon programmée ou non programmée (Urgences Neurologiques) :
              •   les affections du cerveau : AVC, migraine, maladies d'Alzheimer, de Parkinson, épilepsie, sclérose en plaques, troubles du sommeil, tumeurs cérébrales, méningite…
              •   les affections de la moelle épinière : sciatique, névralgie cervico-brachiale, hernie discale, tumeurs…
              •   les affections des nerfs périphériques : polynévrite, syndrome de Guillain-Barré, canal carpien…
              •   les affections des muscles : myopathie, myasthénie…
              Ils pratiquent aussi les explorations fonctionnelles suivantes : électroencéphalogramme (EEG), électromyogramme (EMG), potentiels évoqués, ponction lombaire.
            </p>
