            ...
            <div class="card ">
              <div class="card-header">
                <h4 class="card-title">Départements</h4>
                  ...
                  <a class="btn btn-primary btn-sm" data-toggle="modal" data-target="#addDepartment">Ajouter Département</a>
             ...
             <div class="modal fade" id="editDepartment" tabindex="-1" role="dialog" aria-labelledby="editModalLabel" aria-hidden="true">
                    <div class="modal-dialog" role="document">
                      <div class="modal-content">
                        <div class="modal-header">
                          <h5 class="modal-title text-primary" id="editModalLabel">Edit Département</h5>
                          <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                            <span aria-hidden="true" class="text-primary">&times;</span>
                          </button>
                        </div>
