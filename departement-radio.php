...
<div class="hero-wrap" style="background-image: url('images/bg_8.jpg'); background-attachment:fixed;">
      <div class="overlay"></div>
      <div class="container">
        <div class="row no-gutters slider-text align-items-center justify-content-center" data-scrollax-parent="true">
          <div class="col-md-8 ftco-animate text-center">
            <p class="breadcrumbs"><span class="mr-2"><a href="index.php">Accueill</a></span> <span class="mr-2"><a href="departments.php">Départements</a></span> <span>Radio et analyses</span></p>
            <h1 class="mb-3 bread"> Département<br> Radio et analyses</h1>
          </div>
        </div>
      </div>
    </div>
      ...
      <div class="container">
        <div class="row">
          <div class="col-md-8 ftco-animate">
            <p>
              <img src="images/thesis_img/radio.jpg" alt="" class="img-fluid">
            </p>
            <h5 class="text-danger">SPÉCIALITÉ </5>
            <h2 class="mb-3">Radio et analyses</h2>
            <p>Pour vous accompagner efficacement dans la prise en charge d’examens médicaux complémentaires, un centre d’imagerie médicale et un laboratoire d’analyses sont à votre disposition au sein la Polyclinique de Picardie.
            </p>
            </div> 
          <div class="col-md-4 sidebar ftco-animate">
              ...
              <div class="col-md-8 ftco-animate">
            <h2 class="mb-3  ">Le centre d’imagerie médicale</h2>
            <p>Le centre de radiologie et d’échographie de la Polyclinique de BERKANI MADANI vous accueille au rez-de-chaussée de la clinique du :
            </p>
            <h6 class="mb-3  ">-<strong>lundi au jeudi</strong> de 8h à 12h30 et de 13h30 à 18h,</h6>
            <h6 class="mb-3  ">-<strong>vendredi</strong> de 8h à 12h et de 13h30 à 17h30.</h6>
